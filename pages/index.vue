              ...
              <v-stepper-content step="9">
                <v-card class="mb-12" color="lighten-1">
                  <v-card-title class="headline">
                    ...
                    contact with traveled to China, Iran, UK, Italy, Spain, USA
                    or any country with over 1000 cases?
                  </v-card-title>
                  <v-card-text>
                    <p>
              ...
              <v-stepper-content step="13">
                <v-card class="mb-12" color="lighten-1">
                  <v-card-text>
                    ...
                    <p>
                      Take this test again tomorrow, Call the following Numbers
                      in case there is any issues or concerns:
                    </p>
                    <p>For Ghana: +233 55 843 9868 / +233 50 949 7700</p>
                    <p>
                      For Nigeria: 08000CORONA 08023169485, 08033565529,
